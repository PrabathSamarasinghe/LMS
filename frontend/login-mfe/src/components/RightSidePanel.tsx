const RightSidePanel = () => {
  return (
    <div className="flex-1 bg-black flex items-center justify-center p-8 rounded-l-4xl">
      <div className="text-center text-white">
        <div className="mb-8 justify-center items-center flex flex-col">
          ...
          <h2 className="text-5xl font-light mb-2">GTN LIBRARY</h2>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Discover, explore, and manage your library resources with ease. Access thousands of books, journals, and digital content.
          </p>
          <div className="pt-4 border-t border-gray-700">
            <p className="text-xs text-gray-500 font-light">
              © 2025 GTN Library Management System
            </p>
          </div>
        </div>
      </div>
